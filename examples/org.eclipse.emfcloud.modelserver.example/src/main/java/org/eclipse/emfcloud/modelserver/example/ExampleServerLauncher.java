...
public final class ExampleServerLauncher {
   ...
   private static final String ECORE_TEST_FILE_Inventory = "modelInventory.ecore";
   private static final String XMI_TEST_FILE_Inventory = "ModelInventory.xmi";
   ...
   private static boolean setupTempTestWorkspace(final File workspaceRoot) {
      ...
      result &= result && ResourceUtil.copyFromResource(WORKSPACE_ROOT + "/" + ECORE_TEST_FILE_ANIMAL,
      ...
      result &= result && ResourceUtil.copyFromResource(WORKSPACE_ROOT + "/" + XMI_TEST_FILE_SHAPE,
              new File(workspaceRoot, XMI_TEST_FILE_SHAPE));

      result &= result && ResourceUtil.copyFromResource(WORKSPACE_ROOT + "/" + ECORE_TEST_FILE_Inventory,
              new File(workspaceRoot, ECORE_TEST_FILE_Inventory));
      result &= result && ResourceUtil.copyFromResource(WORKSPACE_ROOT + "/" + XMI_TEST_FILE_Inventory,
              new File(workspaceRoot, XMI_TEST_FILE_Inventory));
